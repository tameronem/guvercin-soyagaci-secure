-- AI Güvercin Eşleştirme Sistemi - Veritabanı Şeması
...
-- İndeksler
CREATE INDEX idx_pigeon_genetics_pigeon ON pigeon_genetics(pigeon_id);
CREATE INDEX idx_pigeon_genetics_trait ON pigeon_genetics(trait_id);
CREATE INDEX idx_breeding_recommendations_user ON breeding_recommendations(user_id);
CREATE INDEX idx_breeding_recommendations_score ON breeding_recommendations(compatibility_score DESC);
CREATE INDEX idx_genetic_relationships_pigeons ON genetic_relationships(pigeon1_id, pigeon2_id);
